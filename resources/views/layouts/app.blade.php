    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-custom shadow-sm py-3">
            <div class="container">
                ...
                @else
                <a class="navbar-brand" href="{{ url('/') }}"><b><img src="{{ asset('assets/images/white-logo.jpg') }}" style="width:150px;"></b></a>
                @endif
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ route('admin.kategori') }}">Data restouran</a>
                        </li>
                        @endif

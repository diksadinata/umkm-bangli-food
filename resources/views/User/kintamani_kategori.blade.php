                    ...
                    <div class="item">
                        <div class="thumb">
                            <div class="hover-content">
                                <ul>
                                    <li><a href="produk/15"><i class="fa fa-eye"></i></a></li>

                                </ul>
                            </div>
                            <img src="assets/images/paperhils.jpg" width="500px" height="500px">
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="item">
                        <div class="thumb">
                            <div class="hover-content">
                                <ul>
                                    <li><a href="produk/16"><i class="fa fa-eye"></i></a></li>

                                </ul>
                            </div>
                            <img src="assets/images/montana.jpg" width="500px" height="500px">
                        </div>
                        <div class="down-content text-center">
                ...
                <div class="col-lg-4">
                    <div class="item">
                        <div class="thumb">
                            <div class="hover-content">
                                <ul>
                                    <li><a href="produk/18"><i class="fa fa-eye"></i></a></li>

                                </ul>
                            </div>
                            <img src="assets/images/ritatkala.jpg" width="500px" height="500px">
                        </div>
                        <div class="down-content text-center">
                ...
                <div class="col-lg-4">
                    <div class="item">
                        <div class="thumb">
                            <div class="hover-content">
                                <ul>
                                    <li><a href="produk/17"><i class="fa fa-eye"></i></a></li>

                                </ul>
                            </div>
                            <img src="assets/images/apungresto-1.webp" width="500px" height="500px">
                        </div>
                        <div class="down-content text-center">

                    ...
                    <div class="item">
                        ...
                        <div class="img-box">
                            <div class="hover-content">
                                <ul>
                                    <li><a href="produk/22"><i class="fa fa-eye"></i></a></li>

                                </ul>
                            </div>
                            
                            <img src="assets/images/warung pak jhon.png" width="500px" height="500px">
</div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="item">
                        <div class="thumb">
                            ...
                            <div class="hover-content">
                                <ul>
                                    <li><a href="produk/19"><i class="fa fa-eye"></i></a></li>

                                </ul>
                            </div>
                            
                            <img src="assets/images/nasi kajeng.png" width="500px" height="500px">
                            </div>
                        </div>
                        <div class="down-content text-center">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="img-box">
                        <div class="thumb">
                            ...
                            <img src="assets/images/OJO DUMEH.png" width="500px" height="500px">
                            </div>
                        </div>
                        <div class="down-content text-center">
                            <h4>Ojo Dumeh</h4>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="img-box">
                        <div class="thumb">
                            ...
                            <div class="hover-content">
                                <ul>
                                    <li><a href="produk/14"><i class="fa fa-eye"></i></a></li>

                                </ul>
                            </div>
                            
                            <img src="assets/images/radja bakso bangli.png" width="500px" height="500px">
                            </div>
                        </div>
                        <div class="down-content text-center">
